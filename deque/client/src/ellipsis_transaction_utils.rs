/// All code from `ellipsis-transaction-utils-1.0.0`. There's an incompatibility with the deps
/// and it's a small lib, so just copy pasting here.
use itertools::Itertools;
use serde::{Deserialize, Serialize};
use solana_sdk::{
    bs58, clock::UnixTimestamp, instruction::CompiledInstruction, message::VersionedMessage,
};
